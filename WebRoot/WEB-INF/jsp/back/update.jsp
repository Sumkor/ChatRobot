...
<body style="background: #e1e9eb;">
	...
	<form action="<%=basePath%>UpdateServlet.action" id="mainForm" method="post">
		...
		<div class="right">
			...
			<div class="rightCont">
				<p class="g_title fix">内容修改</p>
				<table class="tab1">
					<tbody>
						<tr>
							<td width="90" align="right">指令名称：</td>
							<td><input type="text" name="command" class="allInput" value="${message.command}" /></td>
						</tr>
						<tr>
							<td width="90" align="right">描述：</td>
							<td><input type="text" name="description" class="allInput" value="${message.description}" /></td>
						</tr>
						<tr>
							<td width="90" align="right">内容：</td>
							<td><textarea rows="8" cols="35" name="content" class="textareaII">${message.content}</textarea>
							</td>
						</tr>
						<tr>
